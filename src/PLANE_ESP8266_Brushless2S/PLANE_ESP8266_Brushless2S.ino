...
void setup()
{
  ...
  engine_right.attach(14, 500, 2000);
  engine_left.attach(12, 500, 2000);
...
void loop()
{
  ...
  else
  {
    ...
    // Serial.println(";");
    engine_right.write(1000 + int(power_right * 1000 / 100));
    engine_left.write(1000 + int(power_left * 1000 / 100));
